...
export const updatePassword = (phone, password, redirectOnSuccess) => async (dispatch) => {
  try {
    dispatch({
...
export const register = (name, email, phone, password, redirectOnSuccess) => async (dispatch) => {
  try {
    dispatch({
...
// export const verifyUser = (phone, otp) => async 
